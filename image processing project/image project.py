...
def show_image(img_array, parent, title="Image"):
    ...
    frame = tk.LabelFrame(parent, text=title, font=("Arial", 12, "bold"), bg="#ffffff", fg="#333333", bd=2, relief="ridge")
...
# Title label
title_label = tk.Label(root, text="Image Clustering App", font=("Helvetica", 26, "bold"), bg="#1e1e2f", fg="#00d4ff")
